...
## Current download: v0.1.9

[Download ZIP (JSX + installation README)](https://github.com/drewDFP74/scriptMeAE/raw/refs/heads/main/scriptMeAE_v0.1.9.zip)

[What changed](CHANGELOG.md)

## Install or update
1. Download and extract the ZIP. Open the scriptMeAE_v0.1.9 folder; it contains scriptMe_AE.jsx and README.txt.
...
## Validation
The developer's user reported v0.1.9 works as expected and confirmed the update-check flow in AE. Automated tests use a simulated host; they do not establish complete compatibility with every AE/macOS/Windows version.
